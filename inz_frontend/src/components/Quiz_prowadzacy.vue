  ...
  >
    ...
    <v-card>
      <v-toolbar dark color="primary">
        <v-btn icon dark @click="cwiczenie.nowe_zadanie = false">
          <v-icon>mdi-close</v-icon>
        </v-btn>
        <v-toolbar-title> Tworzenie zadania </v-toolbar-title>
      </v-toolbar>
      ...
      <v-form>
        ...
        <v-row justify="center" align="baseline">
          ...
          <v-col cols="1">
            <v-card outlined dark color="secondary"> POPRAWNA </v-card>
          </v-col>
        </v-row>
        ...
        <v-radio-group v-model="poprawna" required>
          ...
          >
            <v-col cols="1">
              <v-btn fab small @click="usun(odpowiedz.id)">
            ...
            <v-col cols="1">
              <v-radio :value="odpowiedz.id"></v-radio>
            </v-col>
          </v-row>
        </v-radio-group>
        ...
        <v-row justify="space-around" dense>
          <v-col cols="10" sm="5">
            <v-card-actions>
              <v-btn dark color="primary" @click="nowa_odp">
                Dodaj odpowiedz
              </v-btn>
            </v-card-actions>
          </v-col>
          ...
          <v-col cols="10" sm="5">
            <v-card-actions>
              <v-btn @click="zatwierdz_zadanie" dark color="primary">
                Zatwierdz zadanie
              </v-btn>
            </v-card-actions>
          </v-col>
            ...
            this.$api
              ...
              .then((response_zadanie) => {
                if (odpowiedz.id == poprawna) {
                  this.$api
                    .put(
                      "quiz/zadania/" + response.data.id + "/wybierz_poprawna/",
                      {
